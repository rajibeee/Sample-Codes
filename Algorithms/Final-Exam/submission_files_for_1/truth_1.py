...
def expressionToTruthTable(expr):
    print ("\n\n\n")
    textfile="truth_table.txt"
	...
	f.write(prop + "\t",)
        ...
        #print(prop + " ", end="")
	#print((prop + " ", end=""), file=f)
	#print(prop + " ", file=f)
	#print(prop + " ")
    #f.write(" " + "".join(expr)+"\n",)  ####This is the expression
    #print(" " + "".join(expr))
    #print((" " + "".join(expr)), file=f)
    ...
    for i in range(combos):
        ...
        for p in range(len(props)):
            ...
            #print((("1" if bit is True else "0") + " ", end=""), file=f)
            #print(("1" if bit is True else "0") + " ",)
	...
	#print((" " + ("1" if evaluation is True else "0")), file=f)
	#f.close()

#expressionToTruthTable(str(sys.argv[1]))
